...
public class UserRelationModel extends AbstractTableModel{
    ...
    public UserRelationModel(String url, UserRelationAdvancedParam advancedVo){
        ...
        try {
            ...
            if(jsonArray != null && jsonArray.size() > 0){
                for(int i = 0;i <jsonArray.size();i++){
                    ...
                    UserRelationAdvancedParam vo = JSONObject.parseObject(JSON.toJSONString(jsonArray.get(i)), UserRelationAdvancedParam.class);
                    hang.add(vo.getId());
                    hang.add(vo.getFriendCode());
                    hang.add(vo.getFriendName());
                    hang.add(vo.getFamiliarity());
